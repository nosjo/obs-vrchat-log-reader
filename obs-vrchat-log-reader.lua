	...
	repeat
		...
		if entry and not firstrun then
			...
			elseif string.find(entry, "[Behaviour] Joining wrld_", nil, true) and obs.obs_data_get_bool(script_settings, "bool_worldna") then
				...
				print("World id: " .. id)
				local handle = io.popen("curl " .. obs.obs_data_get_string(script_settings, "curl_params") .. " -X GET \"https://api.vrchat.cloud/api/1/worlds/wrld_" .. id .. "\" -b \"apiKey=JlE5Jldo5Jibnk5O5hTx6XVqsJu4WJ26\"")
